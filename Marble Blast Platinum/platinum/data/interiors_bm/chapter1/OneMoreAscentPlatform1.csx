...
<ConstructorScene version="4" creator="Torque Constructor" date="2022/07/22 18:42:43">
        ...
        <DetailLevel minPixelSize="0" actionCenter="0 0 0">
            <InteriorMap brushScale="32" lightScale="8" ambientColor="0 0 0" ambientColorEmerg="0 0 0">
                <Entities nextEntityID="7">
                    ...
                    <Entity id="2" classname="path_node" gametype="Torque" isPointEntity="1" origin="-19 -61 26" direction="0 -0 -0">
                        <Properties next_time="1000" smoothing="2" />
                    </Entity>
                    <Entity id="3" classname="path_node" gametype="Torque" isPointEntity="1" origin="-19 -65 26" direction="0 -0 -0">
                        <Properties next_time="1000" smoothing="2" />
                    </Entity>
                    <Entity id="4" classname="path_node" gametype="Torque" isPointEntity="1" origin="-15 -65 26" direction="0 -0 -0">
                        <Properties next_time="1000" smoothing="2" />
                    </Entity>
                    <Entity id="5" classname="path_node" gametype="Torque" isPointEntity="1" origin="-15 -61 26" direction="0 -0 -0">
                        <Properties next_time="1000" smoothing="2" />
                    </Entity>
                    <Entity id="6" classname="path_node" gametype="Torque" isPointEntity="1" origin="-19 -61 26" direction="0 -0 -0">
                        <Properties next_time="1000" smoothing="2" />
                    </Entity>
                </Entities>
                <Brushes nextBrushID="5">
                    <Brush id="0" owner="1" type="999" pos="-19 -61 26" rot="1 0 0 0" scale="" transform="1 0 0 -19 0 1 0 -61 0 0 1 26 0 0 0 1" group="-1" locked="0" nextFaceID="7" nextVertexID="9">
                        <Vertices>
                            <Vertex pos="2 2 0.5" />
                            <Vertex pos="2 2 -0.5" />
                            <Vertex pos="2 -2 0.5" />
                    ...
                    <Brush id="1" owner="0" type="0" pos="-17 -61 26" rot="1 0 0 0" scale="" transform="1 0 0 -17 0 1 0 -61 0 0 1 26 0 0 0 1" group="-1" locked="0" nextFaceID="7" nextVertexID="9">
                        <Vertices>
                    ...
                    <Brush id="2" owner="0" type="0" pos="-17 -65 26" rot="1 0 0 0" scale="" transform="1 0 0 -17 0 1 0 -65 0 0 1 26 0 0 0 1" group="-1" locked="0" nextFaceID="7" nextVertexID="9">
                        <Vertices>
                            <Vertex pos="1.75 0.25 0.25" />
                            <Vertex pos="1.75 0.25 -0.25" />
                            <Vertex pos="2.25 -0.25 0.25" />
                    ...
                    <Brush id="3" owner="0" type="0" pos="-19 -63 26" rot="1 0 0 0" scale="" transform="1 0 0 -19 0 1 0 -63 0 0 1 26 0 0 0 1" group="-1" locked="0" nextFaceID="7" nextVertexID="9">
                        <Vertices>
                    ...
                    <Brush id="4" owner="0" type="0" pos="-15 -63 26" rot="1 0 0 0" scale="" transform="1 0 0 -15 0 1 0 -63 0 0 1 26 0 0 0 1" group="-1" locked="0" nextFaceID="7" nextVertexID="9">
                        <Vertices>
                            <Vertex pos="0.25 2.25 0.25" />
                            <Vertex pos="0.25 2.25 -0.25" />
                            <Vertex pos="0.25 -2.25 0.25" />
